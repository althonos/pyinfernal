...
macro(cython_extension _name)
  ...
  foreach(_link IN LISTS CYTHON_EXTENSION_LINKS)
    message(STATUS "Linking to ${_link}")
  ...
  if(DEFINED PYINFERNAL_INSTALL_LIBS_DIR)
    ...
    endforeach()
    string(APPEND _rpath "${PYINFERNAL_INSTALL_LIBS_DIR}")
